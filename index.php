...
<head>
    ...
    <script>
        ...
        let NepMaxWidth = "500px";

        // Game Url - I set a default game

        let defaultGameUrl = "roms/64-in-1.nes";
        let gameUrl = defaultGameUrl;
    </script>
...
<!-- the body can take one of two classes: 'day' for a clear theme and 'night' for a darker one-->

<body class="day">
    <!-- social media icons -->
    <div id="iconos">
        <a href="#"><i class="icon -medium -github"></i></a><br>
    ...
    <div id="contenedor">
        ...
        <div id="menu" class="menuOn">
            <nav>
                <ul>
                    <li><a href="#" class="button -warning" onclick="irEmulador()">Jugar!</a>
                        <ul>
                            <li><a href="#" class="button -primary" onclick="irRoms()">Elegir
                                    ROM</a></li>
                            <li><a href="#" class="button -primary" onclick="irEmulador()">Aleatorio</a></li>
                            <li><a href="#" class="button -primary">Ayuda</a></li>
                        </ul>
                    </li>
                    <li><a href="#" class="button -warning" onclick="irContacto()">Contacto</a></li>
                    <li><a href="#" class="button -warning" onclick="irBienvenida()">Acerca de</a></li>
                </ul>
            </nav>
            <a id="llaveon" href="#" onclick="cambiarLuz()"><img alt="Apagar la luz!" src="img/LlaveOn.png"></a>
            <!-- For some reason, the 'display:none' property only works correctly from the HTML, not from the external CSS file -->
            <a id="llaveoff" href="#" style="display: none;" onclick="cambiarLuz()"><img alt="Encender la luz!" src="img/LlaveOff.png"></a>
            <a href="#" class="button -success" style="float: right; width: 7.5em; text-align: center;" onclick="irMapa()">Mapa</a>
        </div>

        <!-- 'Cuerpo' section contains the multiple pages to display -->
        ...
        <div id="cuerpo">
            ...
            <div id="seccionEmulador" style="display: flex; padding-left: 15px; padding-top: 5;">
                <div id="instrucciones" style="padding: 5%; width: 40%;">
                    <img class="imagenSaturada" src="img/ControlNes.png">
                </div>
                <div id="emulator">
                    <!--
                        Placeholder para el emulador
                        Emulator placeholder
                -->
                </div>
                <div id="instrucciones2" style="padding: 5%; width: 40%;">
        ...
        <!-- Coming Soon! section (deprecated) -->
        ...
        <!-- end Coming Soon! section (deprecated) -->
